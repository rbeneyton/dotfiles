...
syn keyword cStatement p_delete p_new p_new_raw p_clear p_realloc p_realloc0
syn keyword cStatement t_new t_scope t_dup t_dupz
syn keyword cStatement t_new_raw t_new_extra t_fmt
